        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-[1fr_1.1fr] lg:gap-20 lg:px-10 lg:py-32">
          <div className="relative">
            <div className="relative aspect-[4/5] overflow-hidden rounded-xl shadow-[0_24px_60px_-20px_rgba(67,40,20,0.25)]">
              ...
              <div className="absolute inset-0 rounded-xl ring-1 ring-inset ring-cognac/20" />
            </div>
            {/* Floating stat badge */}
            <div className="absolute -bottom-5 -right-5 hidden flex-col items-center justify-center rounded-full bg-cognac p-6 shadow-xl md:flex" style={{width: 110, height: 110}}>
              <span className="font-serif text-3xl leading-none text-linen">100%</span>
              <span className="mt-1 text-center text-[8px] uppercase tracking-[0.18em] text-linen/80">Medically Guided</span>
            </div>
          </div>
